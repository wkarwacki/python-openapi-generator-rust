...
class ObjectWithObjectInlinedWithAnotherObjectInlinedDto(Dto):
    class InlinedObj(Dto):
        class AnotherInlinedObj(Dto):
        
                str: str

            another_inlined_obj: AnotherInlinedObj

    inlined_obj: InlinedObj
