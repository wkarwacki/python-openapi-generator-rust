...
mod vars {
    ...
    #[test]
    fn gen_kotlin_test() {
        gen_test(Generator::Kotlin, Role::Server, "vars-trust.yml".to_string());
    }

    #[test]
    fn gen_python_server_test() {
        gen_test(Generator::Python, Role::Server, "vars-trust.yml".to_string());
    }
    ...
    fn gen_typescript_test() {
        gen_test(Generator::TypeScript, Role::Server, "vars-trust.yml".to_string());
    }
}
